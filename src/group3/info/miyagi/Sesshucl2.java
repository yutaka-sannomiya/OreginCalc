...
public class Sesshucl2 extends Supo2 {
    double SesshuclTotal;
    public void food() {
            ...
            {int ate = scanner.nextInt();
                ...
                {int foodType = scanner.nextInt();
                    ...
                    if(foodType <4){ //foodType4未満が入力された場合
                        ...
                        this.SesshuclTotal = this.SesshuclTotal + cl[foodType]; //摂取総カロリーの変数にカロリーを代入
                        System.out.println("-----------------------------------------------------------");
                        System.out.println("\t");
        ...
        System.out.println("-----------------------------------------------");
        System.out.println("総摂取カロリーは" + this.SesshuclTotal + "kcalです。"); //総摂取カロリーを表示
        System.out.println("-----------------------------------------------");
    }
}
